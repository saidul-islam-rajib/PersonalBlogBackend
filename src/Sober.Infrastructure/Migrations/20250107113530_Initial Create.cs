    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExperienceSkillSection", x => new { x.ExperienceSectionId, x.ExperienceId });
                    table.ForeignKey(
                        name: "FK_ExperienceSkillSection_Experiences_ExperienceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExperienceSkillSection_ExperienceId",
                table: "ExperienceSkillSection",
                column: "ExperienceId");
