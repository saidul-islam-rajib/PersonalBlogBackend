...
namespace Sober.Infrastructure.Migrations
{
    ...
    [Migration("20241210101332_Add new migration that will create new table for Experiences")]
    partial class AddnewmigrationthatwillcreatenewtableforExperiences
    {
        /// <inheritdoc />
